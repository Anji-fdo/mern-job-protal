...
export default function DashboardComp() {
  ...
  const [lastMonthCourse, setLastMonthCourse] = useState(0);
  ...
  useEffect(() => {
    ...
    const fetchCourse = async () => {
      try {
        const res = await fetch('/api/course/getcourse?limit=5');
        const data = await res.json();
        if (res.ok) {
          setCourse(data.course);
          setTotalCourse(data.totalCourse);
          setLastMonthCourse(data.lastMonthCourse);
        }
      } catch (error) {
        console.log(error.message);
      }
      ...
      <div className='flex-wrap flex gap-4 justify-center'>
        ...
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            ...
            <HiBriefcase className='bg-lime-600  text-white rounded-full text-5xl p-3 shadow-lg' />
          </div>
          <div className='flex  gap-2 text-sm'>
            <span className='text-green-500 flex items-center'>
              <HiArrowNarrowUp />
        ...
        <div className='flex flex-col p-3 dark:bg-slate-800 gap-4 md:w-72 w-full rounded-md shadow-md'>
          <div className='flex justify-between'>
            ...
            <HiBookOpen className='bg-lime-600  text-white rounded-full text-5xl p-3 shadow-lg' />
          </div>
          <div className='flex  gap-2 text-sm'>
            <span className='text-green-500 flex items-center'>
              <HiArrowNarrowUp />
      ...
      <div className='flex flex-wrap gap-4 py-3 mx-auto justify-center'>
        ...
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
          <div className='flex justify-between  p-3 text-sm font-semibold'>
            ...
            <Button outline gradientDuoTone='purpleToPink'>
              <Link to={'/dashboard?tab=job'}>See all</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
        ...
        <div className='flex flex-col w-full md:w-auto shadow-md p-2 rounded-md dark:bg-gray-800'>
          <div className='flex justify-between  p-3 text-sm font-semibold'>
            ...
            <Button outline gradientDuoTone='purpleToPink'>
              <Link to={'/dashboard?tab=course'}>See all</Link>
            </Button>
          </div>
          <Table hoverable>
            <Table.Head>
